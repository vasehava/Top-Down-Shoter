...
public class UserInput : MonoBehaviour
{
   ...
   // public delegate void UpdateWepList();
    public Text wepList;


    public List<Weapon> rewardWepons = new List<Weapon>();
    ...
    public void GetRewardedWep(RewardWeapons id)
    {
        weps.weapons.Add(rewardWepons[(int)id]);
        wepList.text = "#" + (weps.Index + 1) + " of " + weps.weapons.Count;
    }
